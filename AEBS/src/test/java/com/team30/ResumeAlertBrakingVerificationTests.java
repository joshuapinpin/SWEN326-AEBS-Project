 ...
 *   REQ-001  Auditory alert — deduplication confirmation
 *   REQ-002  Visual alert — deduplication confirmation
 *   REQ-006  Wheel speed sensor — braking verification
 *   REQ-013  Braking control signal — links to resume state
 *   REQ-014  Sensor feedback within 50 ms
 *   REQ-015  Deceleration accuracy ±5%
 *   DR-09    Transition to resuming state after braking no longer required
 *   DR-10    Prevent redundant driver alerts while threat level unchanged
...
class ResumeAlertBrakingVerificationTests extends com.team30.AEBSTestBase {
    ...
    // ---------------------------------------------------------------
    // TC-026  REQ-013 / DR-09 — Resume state after threat clears
    // ---------------------------------------------------------------
    ...
    // ---------------------------------------------------------------
    // TC-027  REQ-001 / REQ-002 / DR-10 — Alert deduplication
    // ---------------------------------------------------------------
    ...
    // ---------------------------------------------------------------
    // TC-028  REQ-006 / REQ-014 / REQ-015 / DR-11 — Braking verification
    // ---------------------------------------------------------------
